---
title: "Storm Data :Course Project 2"
author: "Anjali Singh"
...
```{r,echo=FALSE}
grid.arrange(propdam,cropdam,ncol=2)
names(propdamage_10)<-c("Eventype","Loss in Billions $")
names(cropdamage_10)<-c("Eventype","Loss in Millions $")
print("Property Loss")
propdamage_10
print("Crop Loss")
cropdamage_10
